                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="theme-form theme-form-2 mega-form" action="process/insert-product.php" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                                ...
                                                                echo '<select class="js-example-basic-single w-100" id="zelena" name="category">';
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <input class="form-control" type="text"
                                                                placeholder="ex. shoe.jpg" name="picture-link">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <input class="form-control" type="text"
                                                                placeholder="Product Size" name="size">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row align-items-center ex-btn">
                                                                ...
                                                                <div class="col-md-9 col-lg-4">
                                                                    <input class="form-control submit-hover bold" type="submit" value="Add Product">
                                                                </div>
                                                    </div>
                                                </div>
                                            </form>
