        ...
        <div class="page-body-wrapper">
            ...
            <div class="page-body">
                <div class="title-header">
                    <h5>Select A Product To Update</h5>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form class="theme-form theme-form-2 mega-form" action="process/search-product-by-name.php" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="row align-items-center mb-5">
                                                                ...
                                                                <div class="col-md-9 col-lg-4">
                                                                    <input class="form-control bold" type="submit" value="Search By Product Name">
                                                                </div>
                                                    </div>
                                            </form>
                                            <form class="theme-form theme-form-2 mega-form" action="process/search-product-by-id.php" method="POST">
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="col-sm-2 col-form-label form-label-title">Product
                                                            ID</label>
                                                        <div class="col-sm-10">
                                                        <input class="form-control" type="number"
                                                                placeholder="Product ID" name="id">
                                                        </div>
                                                    </div>
                                                    <div class="row align-items-center">
                                                                <label
                                                                    class="col-lg-2 col-md-3 col-form-label form-label-title"></label>
                                                                <div class="col-md-9 col-lg-4">
                                                                    <input class="form-control bold" type="submit" value="Search By ID">
                                                                </div>
                                                    </div>
                                                </div>
                                            </form>
