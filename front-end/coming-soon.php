                    ...
                    <div class="store-container">
                        <div class="border-animation">
                            <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                                <defs>
                                    ...
                                    <g id="tree">
                                        ...
                                        <g opacity="0.4">
                                            ...
                                            <path fill="#f4a9bc" d="M1153.9 561c4-2.4 7.7-5.4 11-8.7" />
                                            <path fill="#f4a9bc" d="M1104.3 545.5c-6.7 1.6-13.1 3.9-19.1 7" />
                                        </g>
                                    ...
                                    <g id="cat">
                                        <circle fill="#f4a9bc" cx="1115" cy="625" r="25"></circle>
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-miterlimit="10"
                                            d="M1097.1 612.3c0 0-4.5-9.3-0.3-17.7 0 0 4.5 5.6 9.3 7" />
                                        <path fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-miterlimit="10"
                                            d="M1140.6 612.3c0 0 4.5-9.3 0.3-17.7 0 0-4.5 5.6-9.3 7" />
                                        <circle fill="#FFF" stroke="#f4a9bc" stroke-width="3" stroke-linecap="round"
                                    ...
                                    <g id="box">
                                        ...
                                        <polygon opacity="0.4" fill="#f4a9bc"
                                    ...
                                    <g id="cap">
                                        ...
                                        <ellipse fill="#f4a9bc" cx="445.9" cy="763.4" rx="8.5" ry="3" />
                                        <path fill="none" class="stroke"
                                        ...
                                        <circle fill="#f4a9bc" cx="429.4" cy="777.4" r="2" />
                                        <circle fill="#f4a9bc" cx="462.4" cy="777.4" r="2" />
                                    </g>
                                    <g id="ball">
                                    ...
                                    <g id="plane">
                                        ...
                                        <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)"
                                            font-family='Fredoka One' font-size="34" fill=""> We are building your store
                                        </text>
                                        <path fill="#f4aebf"
                                ...
                                <circle class="cat-shadow" fill="#f4a9bc" cx="1160" cy="620" r="23"></circle>
                                ...
                                <g id="browser">
                                    ...
                                    <path fill="none" stroke="#f4a9bc" class="stroke"
                                ...
                                <g id="door">
                                    ...
                                    <rect fill="#f4a9bc" x="730" y="700" width="225" height="15"></rect>
                                    <g id="sign">
                                        <polyline fill="none" class="stroke"
                ...
                <div class="col-sm-8 m-auto">
                    <div class="coming-soon-content">
                        <div>
                            ...
                            <p>we are almost there! if you want to get notified when the website goes live, subscribe to
                                our mailing list!</p>
                            <form>
                                <input class="form-control" placeholder="enter your email address">
                                <a href="index.html" class="btn btn-solid-default mt-4">Notify Me!</a>
                            </form>
                        </div>
                    </div>
                </div>
