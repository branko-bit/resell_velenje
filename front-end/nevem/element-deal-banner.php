...
<head>
    ...
    <link rel="icon" href="assets/images/favicon/2.png" type="image/x-icon" />
    <title>Element Deal Banner</title>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="assets/css/element-deal-banner.css">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="nav-submenu menu-content">
                                                    ...
                                                    <li>
                                                        <a href="product-right-thumbnail.html">Product Left Sidebar</a>
                                                    </li>
                                                    <li>
                                                        <a href="product-left-thumbnail.html">Product Left thumbnail</a>
                                                    </li>
                                                    <li>
                                                        <a href="product-right-thumbnail.html">Product No Sidebar</a>
                                                    </li>
                                                    <li>
                ...
                <div class="col-12">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Element Deal Banner</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="">
        <div class="header-image-contain mb-0 section-b-space">
            ...
            <div class="contain-image-box">
                <section class="deal-section pt-3">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="discount-image-details">
                                    <div class="discount-images">
                                        ...
                                        <img src="assets/images/shoes/deal/1.png" alt=""
                                    ...
                                    <div class="discunt-details mt-xl-0 mt-4">
                                        <div>
                                            ...
                                            <h5 class="mt-3">Special Discount <span class="theme-color">70% OFF</span>
                                            </h5>
                                            <h2 class="my-3 deal-text">Deal Of The Day <br>from <span
                                                    class="theme-color">$75</span>
                                            </h2>
                                            <div class="timer-style-2 mt-xl-1 my-2 justify-content-center d-flex">
                                                <ul>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="days" class="theme-color"></h2>Days
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="hours" class="theme-color"></h2>Hour
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="minutes" class="theme-color"></h2>Min
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="seconds" class="theme-color"></h2>Sec
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
        ...
        <div class="header-image-contain mb-0 section-b-space">
            ...
            <div class="contain-image-box">
                <section class="ratio2_1 pt-3">
                    <div class="container">
                        <div class="row gy-3">
                            <div class="col-xl-9 col-lg-8">
                                <div class="timer-banner text-center">
                                    <img src="assets/images/vegetable/percentage.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                    ...
                                    <div class="banner-btn-grup">
                                        ...
                                        <button onclick="location.href = 'shop-left-sidebar.html';" type="button"
                                            class="btn default-theme-1 ms-2">$80.00</button>
                                    </div>
                            ...
                            <div class="col-xl-3 col-lg-4 small-banner">
                                <div class="collection-banner text-center collection-center">
                                    <img src="assets/images/vegetable/offer/2.jpg" class="bg-img blur-up lazyload"
                                        alt="">
                                    <div>
                                ...
                                <div class="discount-image-details-1">
                                    ...
                                    <div class="discunt-details mt-xl-0 mt-4">
                                        <div>
                                            ...
                                            <h2 class="my-2 deal-text">Deal Of The Day <br>from <span
                                                    class="theme-color">$75</span>
                                            </h2>
                                            <div class="timer-style-2 my-2 justify-content-center d-flex">
                                                <ul>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="days2" class="theme-color"></h2>Days
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="hours2" class="theme-color"></h2>Hour
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="minutes2" class="theme-color"></h2>Min
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="seconds2" class="theme-color"></h2>Sec
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="discount-image-details-2">
                                    <div class="discount-images">
                                        <img src="assets/images/flower/offer-1/2.png"
                                            class="img-fluid flower-images-1 blur-up lazyload" alt="">
                                        <img src="assets/images/flower/offer-1/1.png"
                                            class="img-fluid flower-images-2 blur-up lazyload" alt="">
                                    </div>

                                    <div class="discunt-details mt-lg-0 mt-4">
                                        <div>
                                            <div class="heart-button heart-button-light">
                                                <i data-feather="heart"></i>
                                            </div>
                                            ...
                                            <h2 class="mt-3 deal-text">Deal Of The Day <br>from <span
                                                    class="theme-color">$75</span>
                                            </h2>
                                            <div class="timer-style-2 mt-xl-1 my-2 justify-content-center d-flex">
                                                <ul>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="days3" class="theme-color"></h2>Days
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="hours3" class="theme-color"></h2>Hour
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="minutes3" class="theme-color"></h2>Min
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="counter">
                                                            <div>
                                                                <h2 id="seconds3" class="theme-color"></h2>Sec
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                                            <button type="button" onclick="location.href='shop-left-sidebar.html';"
                                                class="btn default-light-theme default-theme mt-2">Shop
                                                Now</button>
                                        </div>
                                    </div>
