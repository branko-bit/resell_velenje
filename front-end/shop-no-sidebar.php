                ...
                <div class="col-lg-12 col-12 ratio_30">
                    <div class="banner-deatils">
                        <div class="banner-image">
                            <img src="assets/images/shop-main.jpg" class="img-fluid bg-img blur-up lazyload"
                                alt="">
                            <div class="banner-content">
                                <div>
                                    <h3 style="backdrop-filter: blur(3px); border-radius: 15px 15px 15px 15px; color:black;">Shop The Latest Trends</h3>
                                    <p></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <!-- Prodcut section -->
                        <?php
                        $sql = "SELECT p_id, name, pic_link, price FROM `products`;";
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        <a href="product-right-thumbnail.php" class="font-default">
                                            <h5 class="ms-0">'.$row['name'].'&nbsp;&nbsp;</h5>
                                        </a>
                                        <div class="listing-content">
                                            <span class="font-light"></span>
                                            <p class="font-light"></p>
                                        </div>
                                        <h3 class="theme-color">'.$row['price'].'€</h3>
                                        <button class="btn listing-content">Add
                                            To Cart</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="product-right">
                                ...
                                <div class="product-btns">
                                    <button type="button" class="btn btn-solid-default btn-sm"
                                        data-bs-dismiss="modal">Reserv for Me</button>
                                    <button type="button" class="btn btn-solid-default btn-sm"
